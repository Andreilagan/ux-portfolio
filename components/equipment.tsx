...
export function Equipment() {
  const tools = [
    ...
    { name: 'Adobe Photoshop', icon: '/adobe-photoshop-logo.png', color: 'text-blue-400', isImage: true },
    { name: 'Webflow', icon: '/webflow-logo.png', color: 'text-blue-400', isImage: true },
